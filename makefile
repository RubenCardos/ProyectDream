...
LDLIBS := `pkg-config --libs-only-l gl OIS OGRE OGRE-Overlay OgreBullet bullet SDL2_mixer` -lstdc++ -lboost_system -lCEGUIBase-0 -lCEGUIOgreRenderer-0 -lOgreOverlay 
